...
const ServiceFlowTaskList = React.memo(({ showApplicationSetter: showTaskDetailsSetter }) => {
        ...
        <>
          <Table>
            <thead>
              <tr>
                <th>
                  Party <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>partySort('assignee', 'desc')}/>
                </th>
                <th>Status <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter()}/></th>
                <th>Responsibility <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter('staffGroup')}/></th>
                <th>Criminal <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter('isCriminal')}/></th>
                <th>Court/Tribunal File # <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter('courtOrTribunalFileNbr')}/></th>
                <th>Registry <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter()}/></th>
                <th>Date Served <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter('servedDate')}/></th>
                <th>Next Appearance Date <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter('nextAppearanceDate')}/></th>
                <th>Edited by <i className="fa fa-angle-down fa-lg font-weight-light" dat-title="Descending" onClick={()=>sorter('assignee')}/></th>
            ...
            {taskServeLegalDocs.map((task, index) => (
              ...
              <tr key={task.id}>
                    ...
                    <td>
                      {/* View / Edit */}
                      <Button className="button-view-edit" onClick={() => { onViewEditChanged(task) }}>
                        View/Edit
                      </Button>
                    </td>
