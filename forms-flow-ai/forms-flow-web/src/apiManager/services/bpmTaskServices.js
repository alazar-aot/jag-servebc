...
import {MAX_RESULTS} from "../../components/TaskView2/constants/taskConstants";

export const fetchServiceTaskList = (filterId,firstResult,reqData,taskIdToRemove,maxResults,...rest) => {

  if (!maxResults){ maxResults = MAX_RESULTS };
  ...
  apiUrlgetTaskList=`${apiUrlgetTaskList}?firstResult=${firstResult}&maxResults=${maxResults}`
